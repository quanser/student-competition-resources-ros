...
def main():
        ...
        # rename .isaac_ros_common-config-quanser-qcar file as .isaac_ros_common-config file
        renameIsaacrosconfig = subprocess.call("mv /home/$USER/Documents/ACC_Development/docker/development_docker/isaac_ros_common_config/.isaac_ros_common-config-quanser-qcar2 /home/$USER/Documents/ACC_Development/docker/development_docker/isaac_ros_common_config/.isaac_ros_common-config", shell=True)
        ...
        renameSourcesList = subprocess.call("mv /home/$USER/Documents/ACC_Development/docker/quanser_docker/quanser_docker_files/miscs/sourcesPhysical.list /home/$USER/Documents/ACC_Development/docker/quanser_docker/quanser_docker_files/miscs/sources.list", shell=True)
        if renameSourcesList !=0:
            print("Could not rename sourcesPhysical.list to sources.list")
            return 1

        ####################################################################
        ########### CLEANUP AND BACKUP OF CLONED REPOSITORIES ##############
        ####################################################################
